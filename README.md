...
After run the main.cpp from Visual studio, one GUI will open from vrep where you have to press apply first then select lin movement and press move robot/run.
